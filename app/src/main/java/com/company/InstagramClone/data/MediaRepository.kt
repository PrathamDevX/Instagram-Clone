...
class MediaRepository {
    ...
    suspend fun uploadImage(uri: Uri): Result<String> = uploadMedia(uri, "image")

    suspend fun uploadVideo(uri: Uri): Result<String> = uploadMedia(uri, "video")

    private suspend fun uploadMedia(uri: Uri, type: String): Result<String> = suspendCancellableCoroutine { continuation ->
